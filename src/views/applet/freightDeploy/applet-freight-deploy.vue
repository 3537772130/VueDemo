      ...
      <div style="width: 100%;float: left;clear: left;margin: auto;">
        <el-form :inline="true" :model="form" :rules="rules" class="demo-form-inline form" ref="form">
          <el-form-item label="最小数">
            <el-input placeholder="请输入最小距离（公里）" v-model.number="form.minimum"
                      @keyup.enter.native="handleClick"></el-input>
          </el-form-item>
          <el-form-item label="最大数">
            <el-input placeholder="请输入最大距离（公里）" v-model.number="form.maximum"
                      @keyup.enter.native="handleClick"></el-input>
          </el-form-item>
          <el-form-item label="运费">
            <el-input placeholder="请输入运费（元）" v-model.number="form.freight"
                      @keyup.enter.native="handleClick"></el-input>
          </el-form-item>
          <el-form-item label=" ">
            ...
            return {
                ...
                rules: {
                    minimum: [
                        ...
                        {type: 'number', min: 1, max: 9999999, message: '请输入数字', trigger: 'blur'}
                    ],
                    maximum: [
