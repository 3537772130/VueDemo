  ...
  <el-container>
    <el-main v-loading="loading" element-loading-text="加载中" style="background-color: #FFFFFF;padding-top: 20px;">
      ...
      <el-table :data="tableData" :height="tableHeight" stripe style="width: 100%">
        ...
        <el-table-column prop="appletName" label="小程序" width="180"></el-table-column>
        <el-table-column prop="couponAmount" label="优惠金额" width="100">
          <template slot-scope="scope">
            <span>{{scope.row.couponAmount|addZero}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="freightAmount" label="快递费" width="100">
          <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit () {
                this.loading = true
                this.$axios({
                    url: '/api/user/order/queryStoreOrderByPage',
                    method: 'post',
                    data: {
